...
ActiveRecord::Schema[8.0].define(version: 2025_06_20_231904) do
  ...
  create_table "job_applications", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["job_seeker_id", "opportunity_id"], name: "index_job_applications_on_job_seeker_id_and_opportunity_id", unique: true
